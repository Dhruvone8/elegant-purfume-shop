...
import { Loader, Filter, X, SlidersHorizontal, ChevronDown } from 'lucide-react';
    ...
    <div className="bg-luxury-cream min-h-screen pt-24 pb-16">
      ...
      <div className="bg-gradient-to-r from-luxury-black to-gray-900 text-white py-20 mb-12 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          ...
          <h1 className="font-serif text-5xl md:text-6xl font-bold mb-4">All Collections</h1>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8 bg-white p-6 rounded-lg shadow-md">
          <div className="flex items-center gap-4">
            <p className="text-gray-700 font-medium">
              <span className="font-bold text-luxury-black text-xl">{filteredProducts.length}</span> {filteredProducts.length === 1 ? 'Product' : 'Products'} Found
            </p>
            {(selectedCategory !== 'All' || selectedGender !== 'All' || priceRange[0] !== 0 || priceRange[1] !== 20000) && (
              <button
        ...
        {showFilters && (
          <div className="bg-white p-8 rounded-lg shadow-lg mb-8 border-t-4 border-luxury-gold animate-fade-in">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Category Filter */}
              <div>
                <h3 className="font-bold text-luxury-black mb-4 uppercase tracking-wider text-sm">Category</h3>
              ...
              {/* Gender Filter */}
              <div>
                <h3 className="font-bold text-luxury-black mb-4 uppercase tracking-wider text-sm">Gender</h3>
                <div className="space-y-2">
                  {genders.map(gender => (
              ...
              {/* Price Range */}
              <div>
                <h3 className="font-bold text-luxury-black mb-4 uppercase tracking-wider text-sm">Price Range</h3>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <div className="bg-white rounded-lg p-12 shadow-md max-w-md mx-auto">
              ...
              <h3 className="text-2xl font-serif font-bold text-luxury-black mb-2">No Products Found</h3>
